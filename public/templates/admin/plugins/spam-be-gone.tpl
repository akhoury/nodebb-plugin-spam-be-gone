                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    ...
                                    <label class="section-title form-check-label">{{tx("spam-be-gone:enable-x", "Akismet")}}</label>
                                </div>
                                <p class="form-text">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">{{tx("spam-be-gone:enable-x", "Honeypot")}}</label>
                                </div>
                                <p class="form-text">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">{{tx("spam-be-gone:enable-x", "Re-Captcha")}}</label>
                                </div>
                                <p class="form-text">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">{{tx("spam-be-gone:enable-x", "StopForumSpam")}}</label>
                                </div>
                                <p class="form-text">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">{{tx("spam-be-gone:enable-x", "hCaptcha")}}</label>
                                </div>
                                <p class="form-text">
